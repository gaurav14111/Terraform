...
resource "azurerm_virtual_network" "dc47-app-vnet"{
    name = "dc47-app-vnet"
...
resource "azurerm_virtual_network" "dc47-app-dr-vnet"{
...
resource "azurerm_virtual_network" "dc47-wan-vnet"{
    name = "dc47-wan-vnet"
...
resource "azurerm_virtual_network" "dc47-wan-dr-vnet"{
...
resource "azurerm_virtual_network" "pb47-vnet"{
    name = "pb47-vnet"
...
resource "azurerm_virtual_network" "pb47-dr-vnet"{
    name = "pb47-dr-vnet"
    address_space = ["12.0.0.0/16"]
    location ="westus2"
    resource_group_name="TFResourceGroup"
